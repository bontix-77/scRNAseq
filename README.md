...
## 🧬 Structure
>[!note]
>sample data goes into the data folder.
>1 subfolder per sample named as the sample and containing for each: matrix.mtx.gz, features.tsv.gz and barcodes.tsv.gz
