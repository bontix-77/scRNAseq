...
saveRDS(adp_filt, "C:/Users/Owner/Documents/github/Seurat test script/seurat 2 basic script/outputs/adp_merge_filt_SCT.rds")
# Check default assay
...
adp_filt <-adp_filt %>% FindNeighbors( reduction = "harmony") %>% FindClusters(resolution = 0.1)


# UMAP for the viasualization of the clusters

adp_filt <-adp_filt %>% RunUMAP( reduction = "harmony", dims=1:20)
DimPlot(adp_filt,
        reduction = "harmony", group.by = c("orig.ident", "seurat_clusters", "time_point", "condition", "condition_tp"),
        alpha = 0.2, ncol = 2
)
DimPlot(adp_filt,
...
saveRDS(adp_filt, "C:/Users/Owner/Documents/github/Seurat test script/seurat 2 basic script/outputs/adp_merge_filt_sctran_clust_harmony.rds")
...
DimPlot(adp_filt,reduction="umap",group.by="seurat_clusters")
saveRDS(adp_filt_markers, "C:/Users/Owner/Documents/github/Seurat test script/seurat 2 basic script/outputs/adp_merge_filt_markers_harmony.rds")
...
hist(sample(JoinLayers(adp_filt@assays$RNA)$count["Gapdh", ], 2500), breaks = 52, main = "Histogram of Gapdh in 2500 random cells", ylab = "Frequency", xlab = "Gene counts")
